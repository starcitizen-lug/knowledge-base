...
{: .warning }
> The most recent Lutris release, 0.5.18/0.5.19, no longer works with Star Citizen out of the box. You may try the steps below, but be aware that others have had issues getting the game to run properly.
