...
1. Install Wine **v9.4** or newer from your distro's repos. If wine is not available from your distro's repos, you may follow the instructions from [winehq](https://gitlab.winehq.org/wine/wine/-/wikis/Download). Fedora users should not install from winehq; they provide a wow64 build which will not work with Star Citizen.
