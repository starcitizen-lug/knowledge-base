...
> Immutable Distros
> 
> For NixOS, see [here](/Alternative-Installations#nixos-installation). For SteamOS and others, see [flatpak installation](Alternative-Installations#flatpak-installation). For the Steam Deck, see [here](/Alternative-Installations#steam-deck-installation).
