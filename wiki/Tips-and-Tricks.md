...
Alternatively, [download](https://github.com/starcitizen-lug/lug-helper/releases/latest) the latest LUG Helper **.tar.gz** archive from git. {% include feed_link.html url="https://github.com/starcitizen-lug/lug-helper/releases.atom" %}  
...
> 
> Turn off any virtual keyboard. These conflict with the `F` interaction key and `w, a, s, d`  and make the inner-thought menu appear to flicker.
>
