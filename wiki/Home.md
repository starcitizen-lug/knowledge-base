...
### Nvidia News
> [!warning]
> (Apr 29, 2024) **Vulkan Beta: Game fails to launch** There is an [issue with LibCUDA](https://github.com/jp7677/dxvk-nvapi/issues/174#issuecomment-2227462795) that prevents vulkan and DLSS from working on linux.
